"""myStaticWatchListDefinitions.py."""

__title__: str = "myStaticWatchListDefinitions"
...
def init_dict_static_watch_list_data() -> dict[str, str]:
    elem = 0
...
DICT_STATIC_WATCH_LIST_DATA: dict[str, str] = dict.fromkeys(LIST_STATIC_WATCH_LIST_COLUMN_NAMES)
